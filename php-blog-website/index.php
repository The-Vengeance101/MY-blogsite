...
<head>
    ...
    <style>
        ...
        .navbar.dark-mode { background-color: #1f1f1f !important; }
        .card.dark-mode { background-color: #2c2c2c; color: #ffffff; }
        .form-control.dark-mode, .btn.dark-mode {
            background-color: #2a2a2a; color: #ffffff; border-color: #444;
        }
        .blog-grid-view {
            display: grid;
        ...
        .category-aside {
            ...
            position: sticky; top: 100px; max-height: 400px; 
        ...
        .main-banner-wrapper { margin-top: 0; width: 100%; overflow: hidden; }
        .main-banner {
                ...
                <div class="card main-blog-card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <!-- <p class="mb-1 text-muted">
                            <i class="fa fa-user"></i> <?= $post['author_name'] ?? 'Guest Author'; ?>
                        </p> -->
                        <?php 
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="react-btns">
                                ...
                                <a href="blog-view.php?post_id=<?=$post_id?>#comments">
                                    <i class="fa fa-comment"></i> Comments (<?= CountByPostID($conn, $post_id); ?>)
                                </a>    
                            </div>    
